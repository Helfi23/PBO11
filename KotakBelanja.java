...
public class KotakBelanja {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("Silahkan Isikan Jumlah Produk yang diInginkan : ");
    ...
    try {
      while(addingProduct) {
        ...
        if (decision == 1) {
          System.out.print("Silahkan Masukan nama produk      : ");
      ...
      System.out.println("Silahkan masukan angka, Jangan masukan selain dari angka");
